...
** Author: James Le
** Date: 11/20/2015
** Description: This is a test driver program where the creatures can test their attributes in a fight
** against one another. The menu has several selection for the user to choose from.
** Input: makefile, ./test
** Output: testDriver
*********************************************************************************************************************/
...
void fightSimulator(Creature*, Creature*);
...
// fighting simulator to help reduce space in the main
void fightSimulator(Creature *offender, Creature *defender)
{

	while (offender->liveCreature() == true && defender->liveCreature() == true)
	{
		if (offender->liveCreature()== true)
		{
			cout << endl;

			cout << defender->getrealName() << " took ";
			offender->fight(defender);

			cout << endl;

		}

		if (defender->liveCreature() == true)
		{
			
			cout << offender->getrealName() << " took ";
			defender->fight(offender);
		...
		cout << offender->getrealName() << " current strength points is: ";
		cout << offender->getstrengthPoint() << endl;


		cout << defender->getrealName() << " current strength points is: ";
		cout << defender->getstrengthPoint() << endl;
